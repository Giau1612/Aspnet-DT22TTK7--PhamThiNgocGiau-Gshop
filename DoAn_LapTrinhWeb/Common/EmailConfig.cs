...
namespace DoAn_LapTrinhWeb.Common
{
    public class EmailConfig
    {
         ...
         */
        public const string emailID = "giaupham1612@gmail.com";
        public const string emailPassword = "123456a@A";
        public const string emailHost = "smtp.gmail.com"; //nếu dùng gmail thì đổi thành  "Host = "smtp.gmail.com"
        public const string emailName = "G-SHOP";//Tên email hiển thị khi gửi
    }
